...
help:
	...
	@echo "  2. make pre-publish - Dry run: build + test + version check"
	@echo "  3. make publish     - Build + upload to PyPI"
	@echo "  4. git tag + push   - Create and push version tag (MANUAL)"
	@echo ""
	@echo "Environment variables:"
	@echo "  PYPI_API_TOKEN      - Required for publish"
	@echo "  PYPI_TEST_API_TOKEN - Required for publish-test"
	@echo ""
	@echo "Full docs: docs/process/release.md"
